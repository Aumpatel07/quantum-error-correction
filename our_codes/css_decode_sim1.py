...
from Restriction_mapping import mapping_error_on_qubits_of_two_edge_augmented_surface_codes_to_error_in_colour_codes,mapping_syndrome_from_colour_code_to_two_edge_augmented_surface_codes

class css_decode_sim1():
    ...
    def __init__(self,hx_surface_codes=None,hx=None, hz=None , **input_dict):
    ...
    def _single_run(self):
        ...
        if self.channel_update is None:
            ...
            syn1,syn2 = mapping_syndrome_from_colour_code_to_two_edge_augmented_surface_codes(self.hx,self.hx_surface_codes,synd_z)
            ...
            new_error_channel1 = np.zeros(self.hx_surface_codes.shape[1])
            new_error_channel2 = np.zeros(self.hx_surface_codes.shape[1])
            


            self.bpd_z1.update_channel_probs(new_error_channel1)
            self.bpd_z2.update_channel_probs(new_error_channel2)
            # print(self.bpd_z1.channel_probs)
            self.bpd_z1.decode(syn1)
            self.bpd_z2.decode(syn2)
            
            # print("osdw")
            self.zosdw_decoding = mapping_error_on_qubits_of_two_edge_augmented_surface_codes_to_error_in_colour_codes(self.hx,self.hx_surface_codes,self.bpd_z1.osdw_decoding,self.bpd_z2.osdw_decoding)
            # print("osd0")
            self.zosd0_decoding = mapping_error_on_qubits_of_two_edge_augmented_surface_codes_to_error_in_colour_codes(self.hx,self.hx_surface_codes,self.bpd_z1.osd0_decoding,self.bpd_z2.osd0_decoding)
            # print("bp")
            ...
            syn3, syn4 = mapping_syndrome_from_colour_code_to_two_edge_augmented_surface_codes(self.hz,self.hx_surface_codes,synd_x)
            ...
            new_error_channel3 = np.zeros(self.hx_surface_codes.shape[1])
            new_error_channel4 = np.zeros(self.hx_surface_codes.shape[1])

            self.bpd_x1.update_channel_probs(new_error_channel3)
            self.bpd_x2.update_channel_probs(new_error_channel4)

            self.bpd_x1.decode(syn3)
            self.bpd_x2.decode(syn4)

            self.xosdw_decoding = mapping_error_on_qubits_of_two_edge_augmented_surface_codes_to_error_in_colour_codes(self.hx,self.hx_surface_codes,self.bpd_x1.osdw_decoding,self.bpd_x2.osdw_decoding)
            self.xosd0_decoding = mapping_error_on_qubits_of_two_edge_augmented_surface_codes_to_error_in_colour_codes(self.hx,self.hx_surface_codes,self.bpd_x1.osd0_decoding,self.bpd_x2.osd0_decoding)
            self.xbp_decoding = mapping_error_on_qubits_of_two_edge_augmented_surface_codes_to_error_in_colour_codes(self.hx,self.hx_surface_codes,self.bpd_x1.bp_decoding,self.bpd_x2.bp_decoding)
    ...
    def _decoder_setup(self):
        ...
        channel_probs_z = 1  *(1- self.error_rate) * self.channel_probs_z[:self.hx_surface_codes.shape[1]]
        channel_probs_x = 1 *(1- self.error_rate) * self.channel_probs_x[:self.hx_surface_codes.shape[1]]
        channel_probs_y = 1 *(1- self.error_rate) * self.channel_probs_y[:self.hx_surface_codes.shape[1]]
